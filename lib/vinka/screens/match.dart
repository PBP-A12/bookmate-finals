                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                              fit: BoxFit.cover,
                              image:
                                  NetworkImage(cards[currentIndex]['picture']),
                            ),
                          ),
                        ),
                      ),
                              ...
                              return WidgetSpan(
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      cards[currentIndex]['interest'][index]
                                          .toString(),
                                      style: const TextStyle(
                                        fontSize: 13,
                                        color: Colors.white,
                      ...
                      const SizedBox(
                          height: 30.0), // Add spacing between card and buttons
                      Column(
                        children: [
                                          ...
                                          TextButton(
                                            onPressed: () async {
                                              ...
                                              final response = await request.post(
                                                  "${globals.domain}/match/accept-flutter/",
                                                  jsonEncode(<String, String>{
                                                    "name": cards[currentIndex]
                                                        ['name'],
                                                    "bio": cards[currentIndex]
                                                        ['bio'],
                                                    "matching_id":
                                                        cards[currentIndex]
                                                            ['matchingId'],
                                                    'id': cards[currentIndex]
                                                        ['userId'],
                                                  }));
                                              if (response['status'] ==
                                                  'success') {
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  const SnackBar(
                                                    content: Text(
                                                        "Explore Your Favorite Books Together!"),
                                                  ),
                                                );
                                              }
                                              fetchNextCard(request);
